  ...
  return (
    <div className="flex flex-col gap-10 w-full">
      ...
      <div className="flex flex-col gap-5">
        ...
        <span className="w-full  bg-light-yellow hover:bg-[#FFC860] text-[#1A2A33] h-[67px] rounded-xl shadow-[inset_0_-9px_0px_#CC8B13]">
          <h2 className="mt-2 text-center">(VS CPU) COMING SOON!</h2>
        </span>
      </div>
    </div>
  )
